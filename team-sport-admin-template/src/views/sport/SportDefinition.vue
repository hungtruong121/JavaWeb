                    ...
                    <form @submit="checkFormCreate" method="post">
                        ...
                        <div class="hafl-set-round-area">
                            ...
                            <div v-for="(item, index) in sectionHalfSetRound" v-bind:key="index" class="row row-space">
                                ...
                                <div class="col-3">
                                    <div class="input-group">
                                        <input class="input--style-4" v-model="item.sportRoundName" maxlength="100" type="text" placeholder="Name..." />
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="input-group">
                                        <input class="input--style-4" v-model="item.sportRoundTime" maxlength="10" type="number" placeholder="Time..." />
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="qty">
                        ...
                        <div class="row row-space p-t-15">
                            ...
                            <div class="col-2">
                                <button class="btn-action-sport btn-success" type="submit">
                                    <b-spinner v-if="isLoading" small></b-spinner> Save
                                </button>
                            </div>
                            <div class="col-3"></div>
                        </div>
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            //    no_image: require("@/assets/resources/no_image.jpg"),
               msgErrors: "",
               msgSuccess: "",
               dismissCountDown: 0,
               dismissSecs: 4,
               ...
               scorePenalForm: { sportPointType: "", sportPointName: "", sportPointDescription: "", sportPointValue: "", sportPointAvatar: require("@/assets/resources/no_image.jpg")},
               sectionScorePenals: [],
               msgScorePenalErr: "",
               ruleDescription: "",
               sectionAttributes: [],
        ...
        methods: {
            ...
            addScorePenal() {
                ...
                if (this.scorePenalForm.sportPointDescription.replace(/^\s+/, '').replace(/\s+$/, '').length > 255){
                    return this.msgScorePenalErr = "Please input description no more than 255 characters!";
                }
                ...
                if (isExisted){
                    ...
                    this.scorePenalForm.sportPointAvatar = 1; 
                    ...
                    this.scorePenalForm.sportPointAvatar = require("@/assets/resources/no_image.jpg");
                }
            },
            ...
            addHalfSetRound(){
                ...
                if (this.halfSetRoundForm.sportRoundName.replace(/^\s+/, '').replace(/\s+$/, '').length > 100) {
                    return this.msgHalfSetRoundErr = "Please input Name no more than 100 characters!";
                }
                if (this.halfSetRoundForm.sportRoundTime <= 0) {
                    return this.msgHalfSetRoundErr = "Input time invalid, please input again!";
                }
                if (this.halfSetRoundForm.sportRoundTime.length > 10) {
                    return this.msgHalfSetRoundErr = "Time is too long or time invalid, please input again!";
                }  
            ...
            addHalfSetRoundExtra(){
                ...
                if (this.halfSetRoundExtraForm.sportRoundName.replace(/^\s+/, '').replace(/\s+$/, '').length > 100) {
                    return this.msgHalfSetRoundExtraErr = "Please input Name no more than 100 characters!";
                }
                if (this.halfSetRoundExtraForm.sportRoundTime <= 0) {
                    return this.msgHalfSetRoundExtraErr = "Input time invalid, please input again!";
                }
                if (this.halfSetRoundExtraForm.sportRoundTime.length > 10) {
                    return this.msgHalfSetRoundExtraErr = "Time is too long or time invalid, please input again!";
                }
            ...
            checkFormCreate(e){
                ...
                let lengthSportName = this.sportName.replace(/^\s+/, '').replace(/\s+$/, '').length;
                switch (true) {
                    case lengthSportName < 3:
                        return this.showAlertError("Please input Sport Name at least 3 characters!");
                    case lengthSportName > 100:
                        return this.showAlertError("Please input Sport Name no more than 100 characters!");
                }
                ...
                if (this.fightOther !== "" && this.fightOther.replace(/^\s+/, '').replace(/\s+$/, '').length > 50){
                    return this.showAlertError("Please input Fight other no more than 50 characters!");
                }
                if (this.competeOther !== "" && this.competeOther.replace(/^\s+/, '').replace(/\s+$/, '').length > 50){
                    return this.showAlertError("Please input Compete other no more than 50 characters!");
                }
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        if (response.data.success){
                            ...
                            this.$router.push({ path: `/sport/listsport` });
                        } else {
        ...
        created() {
            ...
            if (this.id !== null) {
                ...
                let sportsDetail = JSON.parse(localStorage.getItem('sportsDetail'));
                // Get sport in sportsDetail
                var sportDetail = null;
                if (sportsDetail && sportsDetail != null) {
                    sportsDetail.forEach((sport) => {
                        sportDetail = sport.sportId == this.id ? sport : sportDetail;
                    });
        ...
        watch: {
            ...
            id(){
                if (this.id !== null){
                    ...
                    var sportDetail = {};
                    if (sportsDetail && sportsDetail != null) {
                        this.sportsDetail.forEach((sport) => {
                            sportDetail = sport.sportId === id ? sport : sportDetail;
                        });
                        this.convertEntityToDTO(sportDetail);
                    } else {
                        this.$router.push({ path: `/sport/listsport`});
